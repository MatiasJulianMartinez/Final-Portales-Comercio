                ...
                <div class="img-container">
                    <picture>
                        ...
                        <source media="(min-width: 769px) and (max-width: 1680px)"
                            srcset="{{ Storage::url('images/productos/adicional.png') }}">

                        <!-- Ipad -->
                        <source media="(min-width: 601px) and (max-width: 768px)"
                            srcset="{{ Storage::url('images/productos/adicional-respo.PNG') }}">

                        <!-- Mobile -->
                        <source media="(max-width: 600px)" srcset="{{ Storage::url('images/productos/adicional.png') }}">

                        <img class="img-fluid" src="{{ Storage::url('images/productos/adicional.png') }}"
