...
<div class="container my-4">
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        <div class="col">
            <a href="{{ route('admin.section', ['seccion' => 'estadisticas']) }}" class="btn btn-info w-100 p-4 text-white fs-5 fw-medium">📊 Estadísticas</a>
        </div>
    ...
    <div class="d-flex justify-content-center gap-2 my-4 flex-wrap">
       ...
       <a href="{{ route('admin.section', ['seccion' => 'estadisticas']) }}" class="btn btn-info fw-medium text-white">Estadísticas</a>
